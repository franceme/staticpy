...
if __name__ == '__main__':
	...
	if "--short1" in ''.join(sys.argv):
		sys.argv = "zz.py -n self -x run -d dev:lite --Login -p 8887 8888 8912 8899 --dind -c ipy && vs && xonsh && vs && /bin/bash".split(" ")# + ["python -m pip install --upgrade pip xcyl hugg funbelts;/bin/cmd jupyterlab;/bin/cmd vs;/bin/cmd ipy;/bin/bash"]
